...
// template<class T>
// using MyAllocator = MemoryPool<T>; // replace the std::allocator with your allocator

// int main(){
//     std::vector<int, MyAllocator<int>> vecints(10);
//     vecints[9] = 0;
//     std::cout<< vecints[9] <<std::endl;
//     vecints.push_back(1);
//     std::cout<< vecints[10] <<std::endl;
//     MemoryPool<int> pool;
//     std::cout<< pool.max_size() <<std::endl;
//     return 0;
// }
...
//   std::cout << "creating " << TestSize << " vectors of size " << sizeof(IntVec) << std::endl;
...
//   std::cout << "creating " << TestSize << " vectors of size " << sizeof(PointVec) << std::endl;
